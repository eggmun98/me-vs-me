import { apiGet, getAccessToken, restoreSession, type Me } from "@nadaena/api-client";
...
export default function BootScreen() {
  useEffect(() => {
    ...
    void (async () => {
      ...
      try {
        ...
        if (isMounted) router.replace(me.isOnboarded ? "/today" : "/onboarding");
      } catch {
  ...
  return (
    <View style={styles.root}>
      <Text style={styles.logo}>나 VS 나</Text>
...
const styles = StyleSheet.create({
  ...
  logo: { fontSize: 22, fontWeight: "800", color: colors.content, letterSpacing: -0.5 },
});
